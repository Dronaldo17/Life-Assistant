...
-(BOOL)createTableWithModelClass:(Class)model tableName:(NSString*)tableName;
...
-(void)rowCount:(Class)modelClass where:(id)where callback:(void(^)(int rowCount))callback tableName:(NSString*)tableName;
...
-(void)search:(Class)modelClass where:(id)where orderBy:(NSString*)orderBy offset:(int)offset count:(int)count callback:(void(^)(NSMutableArray* array))block tableName:(NSString*)tableName;
...
-(void)insertToDB:(NSObject*)model callback:(void(^)(BOOL result))block tableName:(NSString*)tableName;
...
-(void)insertWhenNotExists:(NSObject*)model callback:(void(^)(BOOL result))block tableName:(NSString*)tableName;
...
-(void)updateToDB:(NSObject *)model where:(id)where callback:(void (^)(BOOL result))block tableName:(NSString*)tableName;
...
-(void)deleteToDB:(NSObject*)model callback:(void(^)(BOOL result))block tableName:(NSString*)tableName;
...
-(void)deleteWithClass:(Class)modelClass where:(id)where callback:(void (^)(BOOL result))block tableName:(NSString*)tableName;
